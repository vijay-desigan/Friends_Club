...
public class profile_navigationActivity2 extends AppCompatActivity {
    Button logout_navigation,test_chat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // test_chat=findViewById(R.id.test_button_chats);
...
//        test_chat.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(profile_navigationActivity2.this,testing_chats.class));
//            }
//        });
